...
const file_twofa_service_proto_rawDesc = "" +
	...
	"\x10ValidateResource\x12).backend.twofa_service.Validate2faRequest\x1a*.backend.twofa_service.Validate2faResponse\"\x00B%Z#github.com/TripConnect/user-serviceb\x06proto3"
