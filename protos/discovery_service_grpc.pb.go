...
const (
	DiscoveryService_Discover_FullMethodName = "/backend.discovery_service.DiscoveryService/Discover"
)
...
type DiscoveryServiceClient interface {
	Discover(ctx context.Context, in *DiscoveryRequest, opts ...grpc.CallOption) (*ServiceInstance, error)
}
...
func (c *discoveryServiceClient) Discover(ctx context.Context, in *DiscoveryRequest, opts ...grpc.CallOption) (*ServiceInstance, error) {
...
type DiscoveryServiceServer interface {
	Discover(context.Context, *DiscoveryRequest) (*ServiceInstance, error)
...
func (UnimplementedDiscoveryServiceServer) Discover(context.Context, *DiscoveryRequest) (*ServiceInstance, error) {
...
var DiscoveryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "backend.discovery_service.DiscoveryService",
