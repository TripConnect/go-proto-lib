...
const file_discovery_service_proto_rawDesc = "" +
	...
	"\bDiscover\x12+.backend.discovery_service.DiscoveryRequest\x1a*.backend.discovery_service.ServiceInstance\"\x00B1Z/github.com/TripConnect/discovery_service;protosb\x06proto3"
